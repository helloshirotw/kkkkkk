//
//  BMGWebViewController.swift
//  bemyguest
//
//  Created by Gary Chen on 2018/12/27.
...
class BMGWebViewController: UIViewController, WKNavigationDelegate, WKUIDelegate {
    var webView: WKWebView!
    var webURL: String!
    class func webViewController(url: String) -> BMGWebViewController {
        let webVC: BMGWebViewController  = BMGWebViewController()
        webVC.webURL    = url
        return webVC
    }
